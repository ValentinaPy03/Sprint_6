...
class OrderScooterPageLocators:
    ...
    DATE_13_01 = [By.XPATH, '//div[@aria-label="Choose понедельник, 13-е января 2025 г."]']
    DATE_30_01 = [By.XPATH, '//div[@aria-label="Choose четверг, 30-е января 2025 г."]']
    FIELD_PERIOD_RENT = [By.XPATH, "//div[@class='Dropdown-control']"]
    TWO_DAYS_PERIOD = [By.XPATH, '//div[text()="двое суток"]']
    FIVE_DAYS_PERIOD = [By.XPATH, '//div[text()="пятеро суток"]']
